...
class TestHealthRouter:
    ...
    def test_health_check_all_unhealthy(self, client: TestClient, mock_user_profile_service,
                                       mock_lie_service, mock_cis_service):
    ...
    def test_health_check_dependency_error(self, client: TestClient, mock_user_profile_service,
                                                mock_lie_service, mock_cis_service):
    ...
    def test_health_check_general_error(self, client: TestClient):
    ...
    def test_liveness_check_failure(self, client: TestClient):
    ...
    def test_health_check_concurrent_requests(self, client: TestClient, mock_user_profile_service,
                                                   mock_lie_service, mock_cis_service):
